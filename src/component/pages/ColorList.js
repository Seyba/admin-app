...
export const ColorList = () => {
    ...
    for(let i = 0; i < colorState.length; i++) {
        data.push({
            ...
            createdAt: colorState[i].createdAt.slice(0, 16).replace('T', ' '),
            updatedAt: colorState[i].updatedAt.slice(0, 16).replace('T', ' '),
            action: 
            <>
                ...
                <Link className="fs-3 text-dark" to="/admin/color">
